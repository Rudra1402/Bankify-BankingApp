...
function CustomDialog({
    ...
    return (
        <CustomCard
            className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 min-h-[33%] h-fit w-11/12 md:w-2/3 lg:w-1/3 rounded-md shadow-md flex flex-col gap-y-2 z-30 bg-gray-200 p-2'
        >
